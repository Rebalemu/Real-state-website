        ...
        <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20 '>
          ...
          <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
            ...
            <p className='my-10 max-w-lg'>
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quo error quaerat tempore ratione eveniet,
              reiciendis debitis sunt, iure dolorem corporis velit cumque vitae. Dolores dolore porro voluptatibus nemo
              quasi a aliquam!
            </p>
