    ...
    <>
      <motion.div
        ...
        <div className='flex justify-end items-center mb-8'>
          <button onClick={previousProject} className='p-3 bg-gray-300 rounded mr-2' aria-label='Previous Projects'>
            <img src={assets.left_arrow} alt='previous' />
          </button>
          <button onClick={nextProject} className='p-3 bg-gray-300 rounded mr-2' aria-label='Next Projects'>
